...
\hline
$k_{\text{vote}}$ & voting/IDW neighborhood size \\
\hline
$K_{\text{density}}$ & local density neighborhood size \\
\hline
$\rho_m(c)$ & global class density in modality $m$ \\
\hline
$\rho_m^{\text{local}}(c)$ & local class density around query \\
\hline
...
One can refer to \autoref{tab:notation} for the notations used throughout the paper.
