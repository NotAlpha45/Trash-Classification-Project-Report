...
\begin{frame}{Robustness Under Imbalance: Figures}
\begin{columns}[T]
  \begin{column}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.58\textheight,keepaspectratio]{images/f1_vs_imbalance.png}
    \\[-2pt]
    {\scriptsize All classes: F1 vs imbalance ratio}
  \end{column}
  \begin{column}{0.61\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.58\textheight,keepaspectratio]{images/f1_vs_minority-imbalance.png}
    \\[-2pt]
